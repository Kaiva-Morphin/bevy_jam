...
fn setup(mut commands: Commands, mut effects: ResMut<Assets<EffectAsset>>, asset_server: ResMut<AssetServer>) {
    commands.spawn((
        Camera3dBundle {
    ...
    let tangent_accel = TangentAccelModifier::constant(&mut module, Vec3::ZERO, Vec3::Z, 150.);
